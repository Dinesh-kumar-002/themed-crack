...
function App() {
  ...
  return (
    <>
      ...
      >
        <Navbar />
        <About settingData={settingData}/>
        <Cart settingData={settingData}/>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sticky top-0">
          ...
          >
            <div className="sticky top-[40px] p-4 mx-w-[600px]">
          ...
          <div className="sm:col-span-12 md:col-span-9 lg:col-span-10">
            <Products selectedValues={selectedValues} rangeRadio={rangeRadio} settingData={settingData} />
          </div>
        <SignUp />
        <Profile/>
        <Login/>
