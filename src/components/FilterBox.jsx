    ...
    >
      <div className="flex search mb-4" width="100%">
        ...
        <select
          ...
          className="border-1 border-slate-300 p-2 me-2  bg-yellow-100 rounded-sm"
        ...
        <input
          ...
          className="w-full p-2 rounded-sm border-1 border-slate-200 outline-0 shadow-0 border-slate-300 bg-yellow-100"
        />
      </div>
