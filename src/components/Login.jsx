...
function Login() {
  ...
  return (
    <div>
         <div
      className="p-5 fixed top-16 w-100 right-0 h-full bg-yellow-50 z-9"
      style={{
    ...
    >
      <div className="flex justify-between mb-2">
        ...
        <h1 className="text-[20px] mb-5 text-slate-600 font-semibold">Login</h1>
      </div>
        ...
        <div>
          <div className="flex shadow-sm">
            <input
              ...
              disabled={emailSet}
              className="block w-full !border-e-0 !rounded-tr-none bg-white !rounded-br-none shadow-sm px-3 rounded-l-sm"
              value={email}
            ...
            <button
              type="button"
              disabled={emailSet}
              className={`px-2 bg-green-600 text-white disabled:opacity-50 h-[36px] font-bold rounded-r-sm`}
        ...
        <span className="text-start !mb-0 text-red-500 font-bold mt-2 block">{emailError}</span>
        <p className="text-center mb-1 text-green-700 font-bold" style={{ display: isCounting ? "block" : "none" }}>
          ...
          <div className="my-5">
            <OtpInput
              ...
              renderInput={(props) => (
                <input
                  {...props}
                  style={{ width: "2.3rem", textAlign: "center",background:"white",border:"1px solid gray" ,height:"2.3rem"}}
                  type="number"
        ...
        <p className="text-center text-green-700 text-[15px] font-bold">{otpError}</p>
